/*
  # Add Walk History and Session Tracking

  1. New Tables
    - `walk_sessions` - Tracks active and completed walks
    - `walk_history` - Stores completed walk data for user history

  2. Schema Changes
    - Add session_id to walk_points for better organization
