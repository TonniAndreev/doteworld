/*
  ...
  1. New Functions
    ...
    - `add_dog_owner`: Allows Alpha Owners to add existing users as owners
    - `transfer_alpha_ownership`: Allows transferring Alpha status to another owner
    - `remove_dog_co_owner`: Updated to enforce hierarchical permissions

  2. Security
    - Only Alpha Owners can add/remove other owners
    - Alpha Owners cannot be removed (only transferred)
    - Regular owners can only remove themselves
    - All ownership changes require proper permissions

  3. Notifications
    - Added notifications for ownership changes
    - Notifications for Alpha ownership transfers
*/
