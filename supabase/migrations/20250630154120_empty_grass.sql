/*
  ...
  1. Schema Updates
    - Add functions to support hierarchical ownership
    - Implement proper role-based permissions
    - Add search functionality for finding users

  2. Security
    - Ensure only Alpha owners can add/remove other owners
    - Implement proper RLS policies for ownership management
    - Add security checks in all functions

  3. Functionality
    - Add function to transfer Alpha ownership
    - Add function to search users for dog ownership
    - Add function to add existing users as owners
*/
