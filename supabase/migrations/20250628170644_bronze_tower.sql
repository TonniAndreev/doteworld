/*
  # Cleanup and Fix Walk System Tables

  1. New Tables
    - `walk_sessions` - Stores walk session data
    - `walk_history` - Archives completed walks
  ...
  3. Security
    ...
    - Add policies with existence checks to prevent duplication
  
  4. Functionality
    - Create update_walk_session_stats() function to update stats when a walk is completed
    - Create views for walk statistics
*/
