/*
  ...
  1. New Functions
    - `notify_dog_invite()`: Trigger function to create notifications when dog ownership invites are sent
  
  2. Tables
    - Ensures `notifications` table exists with proper structure
  
  3. Security
    - Checks for and creates RLS policies for the notifications table if they don't exist
