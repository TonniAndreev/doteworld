/*
  # Walk Sessions and History Management

  1. New Tables
    - walk_sessions: Tracks active walks with real-time data
    - walk_history: Stores completed walks for historical reference
    - Adds session_id to walk_points for proper relationship
