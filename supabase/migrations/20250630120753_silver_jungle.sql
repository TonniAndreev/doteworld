/*
  # Fix Leaderboard and Achievement Issues

  1. Changes
    - Drop and recreate the get_city_leaderboard function with CASCADE to ensure proper recreation
    - Fix the return type mismatch in the function
    - Add proper error handling for achievement unlocking with upsert
    - Ensure city names display correctly with country information
...
-- Update the update_profile_city function to include city name
