/*
  # Create achievements table and sample data

  1. New Table
    - `achievements` - Stores achievement definitions
      - `id` (uuid, primary key) - Unique identifier
      - `key` (text, unique) - Unique string identifier for the achievement
  ...
  2. Junction Table
    - `profile_achievements` - Links users to their earned achievements
      - `profile_id` (uuid) - References profiles(id)
      - `achievement_id` (uuid) - References achievements(id)
      - `obtained_at` (timestamp) - When the achievement was earned

  3. Security
    - Enable RLS on both tables
    - Allow public read access to achievements
    - Allow users to view/manage their own achievements
*/
